...
print(f"Feed Pressure: {res['ro_results']['summary']['feed_pressure_bar']} bar")
print(f"HP Pump Power: {res['ro_results']['summary']['hp_pump_power_kw']} kW")
print(f"HP Pump Cost: {res['economics']['capex']['hp_pump_inr']} INR")
